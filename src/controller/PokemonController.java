...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value1 != null) {
			...
			Bulbasaur b = new Bulbasaur("Bulbaaur", 001,
		...
		if (value2 != null) {
			...
			Charizard c = new Charizard("Charizard", 006,
			...
			request.setAttribute("message1", c.getPokemonNumber());
			request.setAttribute("character1", c.getCharacteristics());
			request.setAttribute("type1", c.getType());
			request.setAttribute("evolution1", c.getEvolution());
			request.setAttribute("baseExp1", c.getBaseExp());
		}
		...
		if (value3 != null) {
			...
			request.setAttribute("message1", d.getPokemonNumber());
			request.setAttribute("character1", d.getCharacteristics());
			request.setAttribute("type1", d.getType());
			request.setAttribute("evolution1", d.getEvolution());
			request.setAttribute("baseExp1", d.getBaseExp());
		}
		...
		if (value4 != null) {
			...
			request.setAttribute("message1", m.getPokemonNumber());
			request.setAttribute("character1", m.getCharacteristics());
			request.setAttribute("type1", m.getType());
			request.setAttribute("evolution1", m.getEvolution());
			request.setAttribute("baseExp1", m.getBaseExp());
		}
		...
		if (value5 != null) {
			...
			request.setAttribute("message1", p.getPokemonNumber());
			request.setAttribute("character1", p.getCharacteristics());
			request.setAttribute("type1", p.getType());
			request.setAttribute("evolution1", p.getEvolution());
			request.setAttribute("baseExp1", p.getBaseExp());
